 ...
 */ export function parseZip64ExtraField(field, needUncompressed, needCompressed) {
 ...
 */ export function parseUnixExtraFieldOld(field) {
 ...
 *   GIDSize: 1 byte
 *   GID: GIDSize bytes
 */ export function parseUnixExtraFieldNew(field) {
 ...
 */ export function parseExtendedTimestamp(field) {
 ...
 */ export function parseAsiExtraField(field) {
 ...
 */ export function findAsiInfo(fields) {
 ...
 */ export function findUnixInfo(fields) {
 ...
 */ export function findExtendedTimestamp(fields) {
    for(let i = 0; i < fields.length; i++){
